  ...
  useEffect(() => {
    const fetchOptions = async () => {
      try {
        ...
        setError(
          "No se pudo cargar las opciones. Inténtelo de nuevo más tarde."
        );
      }
    };
      ...
      <div className="md:w-2/3 w-full bg-white shadow-lg rounded-lg p-12 flex flex-col justify-between">
        <div className="space-y-12">
          ...
          <p className="text-lg text-gray-600 text-center">
            ¡Descubre cuánto podrías ganar! Ingresa tus datos y obtén una
            predicción aproximada de tu sueldo en soles (PEN), basado en tus
